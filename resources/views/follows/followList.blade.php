...
<div class="follows-btns">
  <h2 class="follows-btns_ttl">Follow List</h2>
  <ul class="follows-btns_list">
    @foreach ($followings as $following)
    @if ($following->id !== Auth::user()->id)
    <li class="col-md-4">
      <a class="follows-link" href="{{ url('/profile/' . $following->id) }}">
        <img class="user-image" src="{{ asset('storage/images/'.$following->images) }}" alt="アイコン">
      </a>
    </li>
    @endif
    @endforeach
